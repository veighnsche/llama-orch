...
impl<'a> Writers<'a> {
    pub fn markdown(&self) -> MarkdownWriter<'a> { MarkdownWriter { pb: self.pb } }
    pub fn json(&self) -> JsonWriter<'a> { JsonWriter { pb: self.pb } }
    pub fn ndjson(&self) -> NdjsonWriter<'a> { NdjsonWriter { pb: self.pb } }
    pub fn meta(&self) -> MetaWriter<'a> { MetaWriter { pb: self.pb } }
}

pub struct MarkdownWriter<'a> { pub(crate) pb: &'a ProofBundle }
...
pub struct JsonWriter<'a> { pub(crate) pb: &'a ProofBundle }
impl<'a> JsonWriter<'a> {
...
pub struct NdjsonWriter<'a> { pub(crate) pb: &'a ProofBundle }
...
pub struct MetaWriter<'a> { pub(crate) pb: &'a ProofBundle }
impl<'a> MetaWriter<'a> {
