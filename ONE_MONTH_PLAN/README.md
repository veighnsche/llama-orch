...
**What to Build:**
- queen-rbee (HTTP server, job queue, worker registry)
- rbee-hive (CLI for model downloads, worker spawn)
- rbee-keeper (CLI for SSH commands, job submission)
...
### Do Build (Now)
- ✅ queen-rbee (minimal HTTP server)
- ✅ rbee-hive (CLI)
- ✅ rbee-keeper (CLI)
...
- ✅ Working product (queen-rbee + CLIs + web UI)
...
4. **Start Monday** (Day 1: queen-rbee)
