  ...
  <Story title="UI/Button" :layout="{ type: 'grid', width: 280 }">
    ...
    <Variant title="Playground">
      <div style="padding: 8px;">
        <Button v-bind="propsForButton">{{ effectiveContent }}</Button>
      </div>
    </Variant>

    <!-- Variant presets: by variant -->
    <Variant title="Primary"><Button variant="primary">Primary</Button></Variant>
    <Variant title="Ghost"><Button variant="ghost">Ghost</Button></Variant>
    <Variant title="Link"><Button variant="link">Link</Button></Variant>

    <!-- Sizes -->
    <Variant title="Size: sm"><Button size="sm">Small</Button></Variant>
    <Variant title="Size: md"><Button size="md">Medium</Button></Variant>
    <Variant title="Size: lg"><Button size="lg">Large</Button></Variant>

    <!-- Icon only -->
    <Variant title="Icon sm"><Button size="sm" iconOnly>★</Button></Variant>
    <Variant title="Icon md"><Button size="md" iconOnly>★</Button></Variant>
    <Variant title="Icon lg"><Button size="lg" iconOnly>★</Button></Variant>
    ...
    <template #controls>
      ...
      <HstSelect v-model="state.to" title="to (when as = 'router-link')" :options="['/', '/about', '/contact']" />
