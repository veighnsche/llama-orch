...
<template>
  <Story title="UI/Drawer" :layout="{ type: 'single', width: 360 }">
    ...
    <Variant title="Custom content">
      ...
      <Drawer v-model:open="openCustom" :hide-on-desktop="hideOnDesktop" :aria-role="role" :aria-modal="ariaModal">
        <div style="padding: 6px 2px">
          <p style="margin: 0 0 8px 0">This drawer shows arbitrary content via the default slot.</p>
