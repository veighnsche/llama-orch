    ...
    <section className="relative overflow-hidden border-b border-slate-800 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-amber-500/20 bg-amber-500/10 px-4 py-2 text-sm text-amber-400">
          ...
          <p className="mb-8 text-balance text-xl leading-relaxed text-slate-300">
            Stop depending on AI providers. Use rbee to orchestrate inference across{" "}
            <span className="font-semibold text-white">ALL your home network hardware</span>—GPUs, Macs,
            workstations—with <span className="font-semibold text-white">zero ongoing costs</span>.
          </p>
        ...
        <div className="mx-auto mt-16 max-w-4xl">
          <div className="overflow-hidden rounded-lg border border-slate-800 bg-slate-900 shadow-2xl">
            ...
            <div className="p-6 font-mono text-sm">
              <div className="mb-2 text-slate-400">
                <span className="text-green-400">$</span> rbee-keeper infer --model llama-3.1-70b --prompt
                &quot;Generate API&quot;
              </div>
              ...
              <div className="space-y-1 text-slate-300">
                <div className="animate-[fadeIn_0.5s_ease-in]">
                  <span className="text-blue-400">export</span> <span className="text-amber-400">async</span>{" "}
                  <span className="text-purple-400">function</span> <span className="text-green-400">getUsers</span>
                  () {"{"}
                </div>
                ...
                <div className="animate-[fadeIn_0.9s_ease-in] pl-4">
                  <span className="text-blue-400">return</span> response.<span className="text-green-400">json</span>()
                </div>
