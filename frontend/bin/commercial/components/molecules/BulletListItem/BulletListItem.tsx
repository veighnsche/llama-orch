...
export function BulletListItem({
  ...
  const colorClasses = {
    primary: { bg: 'bg-primary/20', bgSolid: 'bg-primary', text: 'text-primary' },
    'chart-1': { bg: 'bg-chart-1/20', bgSolid: 'bg-chart-1', text: 'text-chart-1' },
    'chart-2': { bg: 'bg-chart-2/20', bgSolid: 'bg-chart-2', text: 'text-chart-2' },
    'chart-3': { bg: 'bg-chart-3/20', bgSolid: 'bg-chart-3', text: 'text-chart-3' },
    'chart-4': { bg: 'bg-chart-4/20', bgSolid: 'bg-chart-4', text: 'text-chart-4' },
    'chart-5': { bg: 'bg-chart-5/20', bgSolid: 'bg-chart-5', text: 'text-chart-5' },
  }

  const colors = colorClasses[color as keyof typeof colorClasses] || colorClasses['chart-3']
