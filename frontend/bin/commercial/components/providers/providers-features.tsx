                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-lg ${
                        activeFeature === feature.id ? "bg-amber-500/20" : "bg-slate-800"
                      }`}
                    >
                      <FeatureIcon
                        className={`h-5 w-5 ${activeFeature === feature.id ? "text-amber-400" : "text-slate-400"}`}
                      />
                    </div>
          ...
          <div className="lg:col-span-2">
            <div className="rounded-2xl border border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 p-8">
              <div className="mb-6 flex items-center gap-4">
                ...
                <div>
                  <h3 className="mb-1 text-2xl font-bold text-white">{active.title}</h3>
                  <p className="text-slate-400">{active.description}</p>
                </div>
              </div>
