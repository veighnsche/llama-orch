    ...
    <section className="py-24 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {/* Card 1 */}
          <div className="bg-card border border-destructive/30 rounded-lg p-8 space-y-4 hover:border-destructive/50 transition-colors">
            <div className="h-12 w-12 rounded-lg bg-destructive/10 flex items-center justify-center">
              <AlertTriangle className="h-6 w-6 text-destructive" />
            </div>
            <h3 className="text-xl font-bold text-foreground">Loss of Control</h3>
          ...
          <div className="bg-card border border-destructive/30 rounded-lg p-8 space-y-4 hover:border-destructive/50 transition-colors">
            ...
            <h3 className="text-xl font-bold text-foreground">Unpredictable Costs</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="bg-card border border-destructive/30 rounded-lg p-8 space-y-4 hover:border-destructive/50 transition-colors">
            ...
            <h3 className="text-xl font-bold text-foreground">Privacy & Compliance Risks</h3>
            <p className="text-muted-foreground leading-relaxed">
