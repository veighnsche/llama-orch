    ...
    >
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Attorney-client privilege maintained. Document analysis, contract review, and legal research with AI while
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Student data protection. AI-powered tutoring, grading assistance, and research tools without sending student
        ...
        <div className="bg-card border border-border rounded-lg p-6 space-y-4">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed">
            Protect trade secrets and proprietary designs. AI-assisted CAD, quality control, and process optimization
