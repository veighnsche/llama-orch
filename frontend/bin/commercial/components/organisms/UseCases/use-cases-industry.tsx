...
import { Banknote, Heart, Scale, Landmark, GraduationCap, Factory } from 'lucide-react'
import Image from 'next/image'
import { SectionContainer } from '@/components/molecules'
import { IndustryCard, type IndustryCardProps } from '@/components/molecules/IndustryCard/IndustryCard'
    ...
    >
      ...
      <div className="max-w-6xl mx-auto mb-8 animate-in fade-in duration-400">
        <p className="text-center text-sm text-muted-foreground mb-6">
          Regulated sectors · Private-by-design
        </p>
