...
export function PricingFAQ() {
  return (
    <SectionContainer title="Pricing FAQs" bgVariant="background">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            All tiers include the full rbee orchestrator with no feature gates. Paid tiers add convenience features like
            Web UI, team collaboration, priority support, and enterprise services. The core AI orchestration is
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Yes. You can upgrade to a paid tier anytime to access additional features. You can also downgrade back to
            the free tier without losing your data or configuration.
          </p>
        </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Yes. We offer 50% discounts for registered non-profits, educational institutions, and open source projects.
