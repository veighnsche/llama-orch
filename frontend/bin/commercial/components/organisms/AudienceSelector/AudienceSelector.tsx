...
import { Code2, Server, Shield, ChevronRight } from 'lucide-react'
    ...
    <section className="relative bg-background py-24 sm:py-32">
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <header className="mx-auto mb-10 max-w-2xl text-center sm:mb-12">
          <p className="mb-4 font-sans text-sm font-medium uppercase tracking-wider text-primary">
            Choose your path
          </p>
          ...
          <p className="font-sans text-lg leading-relaxed text-muted-foreground">
            rbee adapts to how you work—build on your own GPUs, monetize idle capacity, or deploy compliant AI at
            scale.
          </p>
        </header>
