import { HowItWorksSection } from '@/components/organisms'
      ...
      steps={[
        ...
        },
        {
          ...
          block: {
            ...
            copyText: 'rbee-keeper setup add-node --name workstation --ssh-host 192.168.1.10\nrbee-keeper setup add-node --name mac --ssh-host 192.168.1.20',
          },
        },
        {
        ...
        },
        {
          ...
          block: {
            ...
            copyText: "import { invoke } from '@llama-orch/utils';\n\nconst code = await invoke({\n  prompt: 'Generate API from schema',\n  model: 'llama-3.1-70b'\n});",
          },
        },
      ]}
    />
