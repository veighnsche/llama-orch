      ...
      <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
        ...
        <div className="space-y-6">
          ...
          <ul className="space-y-3">
            <BulletListItem title="BDD-Driven Development" description="42/62 scenarios passing (68% complete)" />
            <BulletListItem
              title="Cascading Shutdown Guarantee"
              description="No orphaned processes, clean VRAM lifecycle"
            />
            <BulletListItem title="Process Isolation" description="Clean VRAM lifecycle, no memory leaks" />
            <BulletListItem title="Protocol-Aware Orchestration" description="SSE, JSON, binary protocols supported" />
            <BulletListItem
