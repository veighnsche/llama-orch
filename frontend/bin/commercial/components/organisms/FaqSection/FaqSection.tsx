import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/atoms/Accordion/Accordion'
import { SectionContainer } from '@/components/molecules'

export function FAQSection() {
  return (
    <SectionContainer title="Frequently Asked Questions" bgVariant="secondary">
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="item-1" className="bg-card border border-border rounded-lg px-6">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed">
              Ollama is great for single-machine inference. rbee orchestrates across your entire network—multiple GPUs,
              multiple machines, multiple backends (CUDA, Metal, CPU). Plus, rbee has task-based API with SSE streaming,
              programmable Rhai scheduler, and built-in marketplace federation.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3" className="bg-card border border-border rounded-lg px-6">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed">
              rbee works with CPU-only inference too. It's slower, but functional. You can also federate to external GPU
              providers through the marketplace (coming in M3).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-4" className="bg-card border border-border rounded-lg px-6">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed">
              rbee is currently in M0 (milestone 0) with 68% of BDD scenarios passing. It's suitable for development and
              homelab use. Production-grade features (health monitoring, SLAs, marketplace) are coming in M1-M3 (Q1-Q3
              2026).
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-6" className="bg-card border border-border rounded-lg px-6">
            ...
            <AccordionContent className="text-muted-foreground leading-relaxed">
              Any GGUF model from Hugging Face. Llama, Mistral, Qwen, DeepSeek, etc. Image generation (Stable Diffusion)
              and audio (TTS) coming in M2.
            </AccordionContent>
          </AccordionItem>
