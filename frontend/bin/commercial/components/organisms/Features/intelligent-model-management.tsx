      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        <div className="bg-card border border-border rounded-lg p-8">
          ...
          <div className="bg-background rounded-lg p-6 font-mono text-sm space-y-2">
            ...
            <div className="text-chart-3">→ [model-provisioner] ✅ Model downloaded to /models/tinyllama-q4.gguf</div>
        ...
        <div className="bg-card border border-border rounded-lg p-8">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Before loading any model, rbee validates RAM, VRAM, and disk space. Fail fast with clear error messages
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground text-sm">
                  Ensures GPU has sufficient VRAM for requested backend
                </div>
              </div>
            </div>
            <div className="flex items-start gap-3">
