...
function TabsList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'inline-flex w-full lg:w-auto items-stretch lg:items-start justify-start rounded-none bg-transparent p-0 gap-2 overflow-x-auto lg:overflow-visible snap-x -mx-4 px-4 lg:mx-0 lg:px-0 lg:flex-col',
        className,
      )}
      {...props}
    />
