...
import { AlertTriangle, ArrowRight, Cpu, Gauge } from "lucide-react";
        ...
        items={[
          {
            ...
            solution:
              "Run rbee on a gaming PC + old workstation. Llama-3.1-70B for code; Stable Diffusion for assets.",
          ...
          },
          {
            ...
            scenario:
              "Need comprehensive docs from codebase; API costs are prohibitive.",
            solution:
              "Process entire repos locally with rbee. Generate markdown with examples.",
            outcome:
              "Process entire repos. Zero API costs. Private by default.",
          ...
          },
          {
            ...
            scenario:
              "Writing tests is time-consuming; need AI to generate comprehensive suites.",
            solution:
              "Use rbee + llama-orch-utils to generate Jest/Vitest tests from specs.",
          ...
          },
          {
            ...
            scenario:
              "Small team needs automated code review but cannot afford enterprise tools.",
            solution:
              "Build custom review agent with rbee. Analyze PRs for issues, security, performance.",
          ...
          },
          {
            ...
            scenario:
              "Legacy codebase needs modernization; manual refactoring would take months.",
            solution:
              "Use rbee to refactor code to modern patterns. TypeScript, async/await, etc.",
