const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Button-p0P3vXaT.js","assets/index-G2EA92RG.js","assets/TerminalWindow-B5cyGexH.js"])))=>i.map(i=>d[i]);
...
const _home_vince_Projects_llama_orch_frontend_packages_rbee_ui_src_atoms_Button_Button_Button = () => __vitePreload(() => import('./Button-p0P3vXaT.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.Button);
const _home_vince_Projects_llama_orch_frontend_packages_rbee_ui_src_molecules_Developers_TerminalWindow_TerminalWindow_TerminalWindow = () => __vitePreload(() => import('./TerminalWindow-B5cyGexH.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.TerminalWindow);
__pwRegistry.initialize({ _home_vince_Projects_llama_orch_frontend_packages_rbee_ui_src_atoms_Button_Button_Button,
