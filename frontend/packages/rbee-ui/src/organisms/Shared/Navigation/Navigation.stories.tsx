...
export const WithScrolledPage: Story = {
    ...
    <div>
      ...
      >
        ...
        <p style={{ marginBottom: "1rem" }}>
          Scroll down to see the navigation bar remain fixed at the top with
          backdrop blur effect.
        </p>
        <p>
          The navigation uses a semi-transparent background with backdrop blur
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Navigation with page content to demonstrate fixed positioning and backdrop blur effect.",
      },
    },
  },
};
...
export const FocusStates: Story = {
  render: () => (
    <div>
      ...
      <div style={{ padding: "5rem 2rem" }}>
        ...
        <p style={{ marginBottom: "1rem" }}>
          Press Tab to navigate through the navigation elements:
        </p>
        <ol
          style={{
            listStyle: "decimal",
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Test keyboard navigation and focus states. Use Tab key to navigate through all interactive elements.",
      },
    },
  },
};
