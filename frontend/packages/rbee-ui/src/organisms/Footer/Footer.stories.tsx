...
export const WithPageContent: Story = {
  render: () => (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, padding: '2rem', background: 'linear-gradient(to bottom, transparent, rgba(0,0,0,0.02))' }}>
        <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '1rem' }}>Page Content</h1>
        <p style={{ marginBottom: '1rem' }}>This demonstrates how the footer appears at the bottom of a page with content.</p>
    ...
    <div>
      ...
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)', marginTop: '2rem' }}>
        ...
        <ul style={{ listStyle: 'disc', paddingLeft: '2rem', lineHeight: '1.8' }}>
          <li><strong>Utility Bar</strong>: Quick action buttons (View Docs, Star on GitHub, Join Discord)</li>
          <li><strong>Bottom Bar</strong>: Icon-only links (GitHub, Discussions, Twitter/X, Discord)</li>
        </ul>
