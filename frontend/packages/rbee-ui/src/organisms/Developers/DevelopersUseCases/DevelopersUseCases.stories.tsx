      ...
      <div className="bg-muted p-8">
        ...
        <div className="max-w-2xl mx-auto">
          <p className="text-sm text-muted-foreground mb-4">
            For landing pages targeting a specific use case (e.g., "AI Coding Assistant"), consider showing just one use
            case with more detail, code examples, and a stronger CTA.
          </p>
