...
export const SimplifiedExplanation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Alternative simplified explanation for less technical audiences. Reduces complexity while maintaining key benefits.',
      },
    },
  },
}
    ...
    <div className="space-y-8">
      ...
      <div className="bg-muted p-8">
        ...
        <div className="max-w-3xl mx-auto space-y-4 text-sm">
          <p className="text-muted-foreground">The architecture diagram is a key differentiator. It shows:</p>
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-background p-4 rounded-lg">
              <strong className="block mb-2">Technical Credibility</strong>
              <p className="text-muted-foreground">
                Shows the system is well-architected with clear component separation (queen-rbee, rbee-hive,
                worker-rbee)
              </p>
            </div>
            <div className="bg-background p-4 rounded-lg">
          ...
          <div className="bg-background p-4 rounded-lg">
            ...
            <p className="text-muted-foreground">
              "No daemon drift" and "Clean shutdown" are unique selling points. Most distributed systems leave orphaned
              processes. rbee doesn't.
            </p>
          </div>
        </div>
      </div>
