      ...
      <div className="bg-muted p-8">
        ...
        <div className="max-w-2xl mx-auto space-y-4 text-sm">
          ...
          <div className="bg-background p-4 rounded-lg">
            ...
            <p className="text-muted-foreground">
              "Graceful shutdown with active requests" + "Force-kill after 30s timeout" shows rbee handles both the
              happy path (clean shutdown) and the failure path (force-kill if needed).
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-8">
      ...
      <div className="bg-muted p-8">
        ...
        <div className="max-w-3xl mx-auto space-y-4 text-sm">
          <p className="text-muted-foreground">rbee's VRAM management is a key differentiator for GPU users:</p>
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-background p-4 rounded-lg">
              ...
              <p className="text-muted-foreground">"VRAM cleanup" on shutdown (no leaks, no orphaned allocations)</p>
            </div>
            <div className="bg-background p-4 rounded-lg">
              <strong className="block mb-2">OOM Handling</strong>
              <p className="text-muted-foreground">"OOM during model load" → "abort safely" (no crash, clean error)</p>
            </div>
          </div>
          <div className="bg-background p-4 rounded-lg">
            <strong className="block mb-2">Why This Matters:</strong>
            <p className="text-muted-foreground">
              GPU users are frustrated by mystery VRAM leaks and silent fallbacks. rbee's explicit VRAM management and
              fail-fast policy build trust.
            </p>
          </div>
        </div>
      </div>
