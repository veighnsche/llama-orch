...
export function SolutionSection({
  ...
  return (
    <section
      ...
      className={cn('relative border-b border-border bg-radial-glow px-6 py-24 lg:py-28', className)}
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center animate-in fade-in-50 slide-in-from-bottom-2 duration-500 motion-reduce:animate-none">
          ...
          <h2
            ...
            className="text-balance text-4xl font-extrabold tracking-tight lg:text-5xl"
          >
            {title}
          </h2>
          {subtitle && (
