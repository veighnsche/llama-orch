        ...
        <div className="mx-auto mt-16 max-w-6xl lg:grid lg:grid-cols-12 lg:gap-10 xl:gap-12">
              ...
              {items.map((item, i) => (
                <button
                  ...
                  className={cn(
                    ...
                    activeId === item.id ? 'border-primary bg-primary/5' : 'border-border/70 bg-card',
                  )}
                >
          ...
          <div className="mt-8 lg:col-span-7 lg:mt-0">
            <div className="lg:sticky lg:top-24">
              ...
              {footerNote && <p className="mt-4 text-center text-sm text-muted-foreground">{footerNote}</p>}
            </div>
          </div>
        </div>
      </div>
