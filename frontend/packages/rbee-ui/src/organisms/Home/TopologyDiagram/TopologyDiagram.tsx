    ...
    >
      ...
      <div className={cn('relative w-full', compact ? 'h-[400px]' : 'h-[500px]')}>
        ...
        <p id="topology-desc" className="sr-only">
          Queen-rbee orchestrates work across multiple PCs. Each PC runs its own rbee-hive that manages local devices
          (GPUs, CPUs). Devices report telemetry back to their hive.
        </p>
