        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <p className="mt-3 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-prose">
              rbee is an open-source AI orchestration platform that unifies
              every computer in your home or office into a single,
              OpenAI-compatible AI cluster—private, controllable, and yours
              forever.
            </p>
          </div>
