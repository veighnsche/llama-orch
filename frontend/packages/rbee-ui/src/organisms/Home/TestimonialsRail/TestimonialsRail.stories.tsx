...
const meta = {
  title: 'Organisms/Home/TestimonialsRail',
...
export const DevelopersPageDefault: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'TestimonialsRail as used on the Developers page. Shows developer testimonials with stats, filtered by sector.',
      },
    },
  },
}
...
export const ProvidersPageDefault: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'TestimonialsRail as used on the Providers page. Shows provider testimonials with stats about earnings and uptime.',
      },
    },
  },
}
...
export const StatsOnly: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Stats rail only, without testimonials. Note: This is a contrived example - in practice you would use StatsGrid directly.',
      },
    },
  },
}
...
export const CarouselLayout: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Carousel layout with horizontal scrolling on mobile. On desktop, displays as a grid. Try resizing your browser to see the responsive behavior.',
      },
    },
  },
}
...
export const AllSectors: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'All testimonials from all sectors (developers, providers, enterprise). Useful for home page or general social proof.',
      },
    },
  },
}
