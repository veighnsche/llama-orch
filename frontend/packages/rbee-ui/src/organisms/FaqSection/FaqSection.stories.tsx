...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Default FAQ section with all features: search, category filters, accordion, and support card. Use the theme toggle in the toolbar to switch between light and dark modes.',
      },
    },
  },
};
...
export const WithoutSupportCard: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'FAQ section without the support card sidebar, useful for narrower layouts or when support resources are elsewhere.',
      },
    },
  },
};
  ...
  render: () => (
    <div>
      ...
      <div style={{ padding: '2rem', textAlign: 'center', background: 'rgba(0,0,0,0.02)' }}>
        ...
        <ol style={{ listStyle: 'decimal', paddingLeft: '2rem', textAlign: 'left', maxWidth: '600px', margin: '0 auto', lineHeight: '1.8' }}>
  ...
  render: () => (
    <div>
      ...
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>Category Organization</h2>
        <div style={{ maxWidth: '800px', margin: '0 auto', display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
          <div>
...
export const SupportCardHighlight: Story = {
  render: () => (
    <div>
      <FAQSection />
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>Support Resources</h2>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <ul style={{ listStyle: 'disc', paddingLeft: '2rem', lineHeight: '1.8' }}>
            <li><strong>GitHub Discussions</strong>: Ask questions and get help from the community</li>
            <li><strong>Setup Guide</strong>: Step-by-step documentation for getting started</li>
            <li><strong>Email Support</strong>: Direct contact for urgent issues</li>
          </ul>
          <p style={{ marginTop: '1rem', color: '#666' }}>The card is sticky-positioned for easy access while scrolling.</p>
        </div>
      </div>
    </div>
  ),
...
export const SEOFeatures: Story = {
  render: () => (
    <div>
      <FAQSection />
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>SEO Features</h2>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>JSON-LD Structured Data</h3>
          <p style={{ marginBottom: '1rem', color: '#666' }}>The FAQ section includes FAQPage schema markup for search engines. This helps Google display rich snippets in search results.</p>
          
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Semantic HTML</h3>
          <p style={{ marginBottom: '1rem', color: '#666' }}>Uses proper semantic elements: &lt;section&gt;, &lt;nav&gt;, &lt;aside&gt;, and heading hierarchy.</p>
          
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Accessibility</h3>
          <p style={{ color: '#666' }}>ARIA labels, keyboard navigation, and screen reader support ensure the FAQ is accessible to all users.</p>
        </div>
      </div>
    </div>
  ),
