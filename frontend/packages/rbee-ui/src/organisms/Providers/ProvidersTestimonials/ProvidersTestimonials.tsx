		...
		>
			<div className="mx-auto max-w-7xl">
				...
				<header className="animate-in fade-in-50 slide-in-from-bottom-2 mb-14 text-center motion-reduce:animate-none">
					...
					<h2 id="providers-h2" className="mb-3 text-balance text-4xl font-bold text-foreground lg:text-5xl">
						What Real Providers Are Earning
					</h2>
					<p className="mx-auto max-w-2xl text-pretty text-lg text-muted-foreground">
						GPU owners on the rbee marketplace turn idle time into steady payouts—fully self-managed, OpenAI-compatible
						infrastructure.
					</p>
				...
				{/* Testimonials Rail */}
				<div className="mb-12">
					<TestimonialsRail sectorFilter="provider" layout="carousel" headingId="providers-h2" />
				</div>
