...
export const enterpriseHeroProps: EnterpriseHeroProps = {
  ...
  stats: [
    ...
    },
    {
      ...
      helpText:
        "Immutable audit logs retained for 7 years per GDPR requirements",
    },
    {
      value: "Zero",
      label: "US Cloud Deps",
      helpText:
        "No dependencies on US cloud providers; EU-native infrastructure",
    },
  ],
  primaryCta: {
    text: "Schedule Demo",
...
export const enterpriseEmailCaptureProps: EmailCaptureProps = {
  ...
  subheadline:
    "Join enterprises that have taken control of their compliance and data sovereignty.",
  emailInput: {
 ...
 */
export const enterpriseProblemTemplateContainerProps: Omit<
 ...
 */
export const enterpriseSolutionContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseComplianceContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
...
export const enterpriseComplianceProps: EnterpriseComplianceProps = {
  ...
  auditReadiness: {
    ...
    noteAriaLabel:
      "Compliance pack includes endpoints, retention policy, and audit-logging design",
    buttons: [
      {
 ...
 */
export const enterpriseSecurityContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseHowItWorksContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseUseCasesContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseComparisonContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseFeaturesContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseTestimonialsContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
 ...
 */
export const enterpriseTestimonialsData: TestimonialsTemplateProps = {
  testimonials: TESTIMONIALS.filter((t) =>
    ["finance", "healthcare", "legal"].includes(t.sector)
  ).map((t) => ({
    quote: t.quote,
    author: t.name,
    role: t.role,
...
/**
 * Enterprise CTA container - wraps the CTA section
 */
export const enterpriseCTAContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
  eyebrow: (
    <span className="font-sans text-orange-500">Get Audit-Ready</span>
  ),
  ...
  align: "center",
  ctas: {
    caption: "Enterprise support 24/7 • Typical deployment: 6–8 weeks from consultation to production.",
  },
};

/**
 * Enterprise CTA - Final call to action section
 */
