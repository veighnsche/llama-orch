 ...
 */
export const enterpriseEmailCaptureContainerProps: Omit<TemplateContainerProps, 'children'> = {
  title: null,
  background: {
    variant: 'background',
  },
...
export const enterpriseFeaturesGridProps: CardGridTemplateProps = {
  columns: 2,
  gap: 'md',
  cards: enterpriseFeaturesData.map((feature, index) => <SecurityCard key={index} {...feature} />),
}
...
export const enterpriseTestimonialsData: TestimonialsTemplateProps = {
  testimonials: TESTIMONIALS.filter((t) => ['finance', 'healthcare', 'legal'].includes(t.sector)).map((t) => ({
    quote: t.quote,
    author: t.name,
    role: t.role,
    avatar: t.avatar,
 ...
 */
export const enterpriseCTAContainerProps: Omit<TemplateContainerProps, 'children'> = {
