...
export const providersProblemContainerProps: Omit<
...
> = {
  ...
  description:
    "Most GPUs sit idle ~90% of the time. They still draw power—and earn nothing.",
  bgVariant: "default",
  paddingY: "2xl",
  maxWidth: "7xl",
  align: "center",
...
export const providersProblemProps: ProblemTemplateProps = {
  ...
  ctaCopy:
    "Every idle hour is money left on the table. Turn that waste into passive income with rbee.",
};

// === ProvidersSolution Template ===
export const providersSolutionContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
...
export const providersSolutionProps: SolutionTemplateProps = {
  ...
  earnings: {
    ...
    disclaimer:
      "Actuals vary with demand, pricing, and availability. These are conservative estimates.",
  },
  ctaPrimary: {
    label: "Start Earning",
    href: "/signup",
  ...
  steps: [
    ...
    },
    {
      ...
      block: {
        ...
        content: (
          <>
            Set your pricing, availability windows, and usage limits through the
    ...
    },
    {
      ...
      block: {
        ...
        content: (
          <>
            Your GPUs automatically appear in the rbee marketplace. Developers
            can discover and rent your compute power.
            <div className="mt-2 text-sm font-medium text-green-600">
              ✓ Your GPUs are now live and earning.
            </div>
          </>
        ),
      },
    },
    {
      ...
      block: {
        ...
        content: (
          <>
            Track earnings in real time. Automatic payouts to your bank or
            crypto wallet.
...
export const providersFeaturesProps: FeaturesTabsProps = {
  ...
  tabs: [
    {
      ...
      badge: "Control",
      description:
        "Set your own hourly rates based on GPU model, demand, and your preferences.",
      content: (
        <CodeBlock
          code={`{
  "gpu": "RTX 4090",
  ...
  "auto_pause_gaming": true
    ...
    },
    {
      ...
      badge: "Safe",
      description:
        "Your data and hardware are protected with enterprise-grade security.",
      content: (
    ...
    },
    {
      ...
      badge: "Insights",
      description:
        "Track your earnings, utilization, and performance in real‑time.",
      content: (
...
export const providersUseCasesContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
  ...
  description:
    "From gamers to homelab builders, anyone with a spare GPU can turn idle time into income.",
  bgVariant: "default",
  paddingY: "2xl",
  maxWidth: "7xl",
  align: "center",
  ...
  cases: [
    {
      ...
      quote:
        "I game ~3-4 hours/day. The rest, my 4090 was idle. Now it earns ~€150/mo while I'm at work or asleep.",
      facts: [
    ...
    },
    {
      ...
      quote:
        "Four GPUs across my homelab bring ~€400/mo. It covers power and leaves profit.",
      facts: [
    ...
    },
    {
      ...
      quote:
        "After PoS, my rig idled. rbee now earns more than mining—with better margins.",
      facts: [
    ...
    },
    {
      ...
      quote:
        "My RTX 4080 is busy on renders only. The rest of the time it makes ~€100/mo on rbee.",
      facts: [
...
export const providersEarningsContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
...
export const providersMarketplaceContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
  kicker: "Why rbee",
...
export const providersSecurityContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
...
export const providersTestimonialsContainerProps: Omit<
  TemplateContainerProps,
  "children"
> = {
