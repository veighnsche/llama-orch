...
> = {
  ...
  description:
    "19+ error scenarios with clear messages and actionable fixes—no cryptic failures.",
  bgVariant: "background",
  paddingY: "2xl",
  maxWidth: "6xl",
  align: "center",
...
export const errorHandlingProps: ErrorHandlingTemplateProps = {
  ...
  terminalFooter: (
    <div className="flex items-center gap-2 text-sm text-chart-3 font-sans">
      ...
      <span>
        Exponential backoff with random jitter (0.5–1.5×). SSH: 3 attempts ·
        HTTP: 3 · Downloads: 6 with resume.
      </span>
    </div>
  ),
  playbookCategories: [
    {
      ...
      description:
        "Detects timeouts, auth failures, and HTTP errors. Retries with exponential backoff + jitter.",
      checks: [
        {
          severity: "destructive",
          title: "SSH connection timeout",
          meaning:
            "Remote host didn't respond within threshold; likely egress or firewall.",
    ...
    },
    {
      ...
      description:
        "Fail-fast on RAM/VRAM limits with actionable fixes and pre-download disk checks.",
      checks: [
        {
          severity: "primary",
    ...
    },
    {
      ...
      description:
        "Validates model presence, credentials, and backend availability before work starts.",
      checks: [
        {
          severity: "chart-2",
    ...
    },
    {
      ...
      description:
        "Observes workers from startup to shutdown; offers safe teardown and timeouts.",
      checks: [
        {
          severity: "destructive",
...
> = {
  ...
  description:
    "Live narration of each step—model loading, token generation, resource usage—as it happens.",
  bgVariant: "background",
  paddingY: "2xl",
  maxWidth: "6xl",
  align: "center",
...
export const realTimeProgressProps: RealTimeProgressProps = {
  ...
  terminalContent: (
    <div className="max-h-[340px] overflow-auto" role="log" aria-live="polite">
      ...
      <div className="text-foreground animate-in fade-in duration-300 delay-600">
        Once upon a time…
      </div>
  ...
  terminalFooter: (
    <div className="flex items-center justify-between">
      <div className="text-xs text-muted-foreground">
        Narration → <code className="bg-muted px-1 rounded">stderr</code> ·
        Tokens → <code className="bg-muted px-1 rounded">stdout</code>
      </div>
...
> = {
  ...
  description:
    "Defense-in-depth with six focused Rust crates. Enterprise-grade security for your homelab.",
  bgVariant: "background",
  paddingY: "2xl",
  maxWidth: "6xl",
  align: "center",
