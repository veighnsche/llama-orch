...
export const CompactVariant: Story = {
	args: {
		...
		body: 'Custom deployment, SSO, and priority support—delivered with SLAs tailored to your risk profile.',
		action: (
			<Button variant="default" size="sm" className="hover:translate-y-0.5 active:translate-y-[1px] transition-transform">
				Contact Sales
			</Button>
		),
		tone: 'primary',
	...
	parameters: {
		docs: {
			description: {
				story: 'Compact variant with reduced padding (p-5) for tighter layouts. Pass `className="p-5"` to override default spacing.',
			},
		},
	},
}
