...
export function EarningsCard({ title, amount, subtitle, stats, breakdown, className }: EarningsCardProps) {
	return (
		<div className={cn('rounded-2xl border border-border bg-gradient-to-b from-card to-background p-8', className)}>
