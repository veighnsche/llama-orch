...
export function AudienceCard({
	...
	return (
		<div className="flex flex-col">
			...
			{decisionLabel && <div className={cn('mb-3 text-sm font-medium', colors.text)}>{decisionLabel}</div>}
			...
			>
				...
				<div className="mb-6 flex items-center gap-3">
					...
					{imageSlot && (
						<div className="h-14 w-14 shrink-0 overflow-hidden rounded-lg bg-card ring-1 ring-border">{imageSlot}</div>
					)}
				</div>
