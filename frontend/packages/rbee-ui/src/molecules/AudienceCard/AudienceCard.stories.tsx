...
export const Default: Story = {
  args: {
    ...
    description:
      "Self-hosted LLM infrastructure for your applications. Full control, zero vendor lock-in.",
    features: [
...
export const Enterprise: Story = {
  args: {
    ...
    description:
      "GDPR-compliant, SOC2-ready AI infrastructure hosted in the Netherlands.",
    features: [
...
export const Provider: Story = {
  args: {
    ...
    description:
      "Turn idle GPU capacity into revenue by joining the rbee network.",
    features: [
...
export const AllColors: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "All available color variants. Each color creates a different visual hierarchy and emotional response.",
      },
    },
  },
};
    ...
    <div className="space-y-12 p-8 bg-background">
      <div>
        <h2 className="text-2xl font-bold mb-4 text-foreground">
          Original Design (Plain div, no Card atom)
        </h2>
      ...
      <div>
        <h2 className="text-2xl font-bold mb-4 text-foreground">
          New Design (Card atom + ButtonCardFooter)
        </h2>
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <AudienceCard
            icon={<Code className="size-6" />}
