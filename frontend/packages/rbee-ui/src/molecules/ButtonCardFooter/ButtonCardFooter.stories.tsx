    ...
    <Card className="w-[400px]">
      <CardContent className="p-6">
        ...
        <p className="text-muted-foreground">
          This is some card content that demonstrates the sticky footer.
        </p>
      </CardContent>
...
export const WithBadge: Story = {
  args: {
    badgeSlot: <span className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-xs font-medium text-primary">Special Offer</span>,
  ...
  render: (args) => (
    <Card className="w-[400px]">
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold mb-2">Card Title</h3>
        <p className="text-muted-foreground">
          This card has a badge above the button.
        </p>
      </CardContent>
      <ButtonCardFooter {...args} />
    </Card>
...
export const Elevated: Story = {
  args: {
    variant: "elevated",
    badgeSlot: <span className="inline-flex items-center rounded-full bg-destructive/10 px-3 py-1 text-xs font-medium text-destructive">Limited Time</span>,
  ...
  render: (args) => (
    <Card className="w-[400px]">
      <CardContent className="p-6">
        <h3 className="text-lg font-semibold mb-2">Card Title</h3>
        <p className="text-muted-foreground">
          This footer has elevated shadow variant.
        </p>
      </CardContent>
      <ButtonCardFooter {...args} />
    </Card>
