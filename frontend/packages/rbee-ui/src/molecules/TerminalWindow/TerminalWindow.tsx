    ...
    <div className={cn('bg-card border border-border rounded-lg overflow-hidden shadow-2xl', className)}>
      <div className="flex items-center gap-2 px-4 py-3 bg-muted border-b border-border">
        <div className="flex gap-2" aria-hidden="true">
          <div className="h-3 w-3 rounded-full" style={{ backgroundColor: 'var(--terminal-red)' }}></div>
          <div className="h-3 w-3 rounded-full" style={{ backgroundColor: 'var(--terminal-amber)' }}></div>
          <div className="h-3 w-3 rounded-full" style={{ backgroundColor: 'var(--terminal-green)' }}></div>
        </div>
