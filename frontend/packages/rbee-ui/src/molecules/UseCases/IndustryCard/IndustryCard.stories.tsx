...
import { Building2, GraduationCap, Briefcase, ShoppingCart } from 'lucide-react'
import { IndustryCard } from './IndustryCard'

const meta: Meta<typeof IndustryCard> = {
	title: 'Molecules/UseCases/IndustryCard',
...
export const InIndustryContext: Story = {
	render: () => (
		<div className="w-full max-w-6xl">
			<div className="mb-4 text-sm text-muted-foreground">
				Example: IndustryCard in UseCasesIndustry organism
			</div>
	...
	parameters: {
		docs: {
			description: {
				story: 'IndustryCard as used in the UseCasesIndustry organism, showing multiple industries with scroll anchors.',
			},
		},
	},
}
