...
import { PlaybookItem, PlaybookHeader } from './PlaybookAccordion'

const meta: Meta<typeof PlaybookItem> = {
	title: 'Molecules/ErrorHandling/PlaybookAccordion',
				...
				<div className="px-6 pb-5 border-t border-border/80">
					...
					<ul className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
						<li className="flex items-start gap-2">
							...
							<span>High latency <span className="text-muted-foreground">(Check network)</span></span>
						</li>
						<li className="flex items-start gap-2">
							<span className="mt-2 size-1.5 rounded-full bg-chart-2/80 shrink-0" />
							<span>GPU throttling <span className="text-muted-foreground">(Check temperature)</span></span>
						</li>
						<li className="flex items-start gap-2">
							<span className="mt-2 size-1.5 rounded-full bg-chart-3/80 shrink-0" />
							<span>Memory pressure <span className="text-muted-foreground">(Check VRAM)</span></span>
						</li>
					</ul>
				</div>
			</details>
