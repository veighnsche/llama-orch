    ...
    <div className="flex flex-col gap-6 p-8 max-w-2xl">
      ...
      <ul className="space-y-4">
        ...
        <FeatureListItem
          ...
          iconColor="chart-1"
        />
        <FeatureListItem icon={Lock} title="Chart-2 Color" description="Another color option" iconColor="chart-2" />
        <FeatureListItem icon={Lock} title="Chart-3 Color" description="Success/positive color" iconColor="chart-3" />
        <FeatureListItem icon={Lock} title="Chart-4 Color" description="Warning/attention color" iconColor="chart-4" />
        <FeatureListItem icon={Lock} title="Chart-5 Color" description="Info/neutral color" iconColor="chart-5" />
      </ul>
    </div>
  ),
  parameters: {
