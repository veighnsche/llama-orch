...
const meta = {
	title: 'Atoms/Icons/Brand/GitHubIcon',
...
- **Developers Page CTA**: Secondary button with GitHub icon (iconLeft prop)
- **Footer**: Social media links section
- **Navigation**: Optional GitHub repository link
        `,
			},
		},
	},
...
export const ColoredVariants: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					'GitHubIcon in various colors. The icon inherits currentColor, making it easy to style with Tailwind text utilities.',
			},
		},
	},
}
