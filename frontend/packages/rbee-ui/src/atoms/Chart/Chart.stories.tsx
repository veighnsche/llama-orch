...
export const Default: Story = {
	render: () => (
		<div className="w-[400px] h-[300px] border rounded-lg p-4 flex items-center justify-center bg-muted">
...
export const AllTypes: Story = {
	render: () => (
		<div className="flex flex-col gap-4">
			<div className="w-[400px] h-[200px] border rounded-lg p-4 flex items-center justify-center bg-muted">
...
export const Responsive: Story = {
	render: () => (
		<div className="w-full max-w-2xl h-[300px] border rounded-lg p-4 flex items-center justify-center bg-muted">
