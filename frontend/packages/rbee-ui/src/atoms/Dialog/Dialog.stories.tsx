			...
			<DialogContent>
				...
				<div className="grid gap-4 py-4">
					...
					<div className="grid gap-2">
						...
						<input id="email" type="email" className="border rounded px-3 py-2 text-sm" defaultValue="john@example.com" />
					</div>
				</div>
				<DialogFooter>
			...
			<DialogContent className="max-h-[80vh] overflow-y-auto">
				...
				<div className="space-y-4 py-4">
					{Array.from({ length: 20 }).map((_, i) => (
						<p key={i} className="text-sm">Paragraph {i + 1}: Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
					))}
				</div>
				<DialogFooter>
					<Button>Close</Button>
