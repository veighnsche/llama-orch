...
function Textarea({ className, ...props }: React.ComponentProps<'textarea'>) {
  return (
    <textarea
      data-slot="textarea"
      className={cn(
        'border-input placeholder:text-slate-400 dark:placeholder:text-[#8b9bb0] bg-white dark:bg-[color:var(--background)] flex field-sizing-content min-h-16 w-full rounded border px-3 py-2 text-base transition-[color,box-shadow,border-color] disabled:cursor-not-allowed md:text-sm',
