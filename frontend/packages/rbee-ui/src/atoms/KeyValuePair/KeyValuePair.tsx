...
export interface KeyValuePairProps {
  ...
  valueVariant?: 'default' | 'semibold' | 'bold' | 'success' | 'warning' | 'error'
...
export function KeyValuePair({ label, value, valueVariant = 'semibold', className }: KeyValuePairProps) {
  return (
    <div className={cn('flex items-center justify-between gap-6 text-sm', className)}>
