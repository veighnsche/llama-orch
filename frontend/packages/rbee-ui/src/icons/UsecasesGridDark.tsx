...
export function UsecasesGridDark({ size = 1920, className, ...props }: UsecasesGridDarkProps) {
  ...
  <g id="gamingPC">
    ...
    <rect x="260" y="260" width="200" height="260" rx="8" fill="#0a0f1a" stroke="#1e293b" strokeWidth="3"/>
    
    {/* Tempered glass side panel */}
    <rect x="270" y="270" width="90" height="240" rx="6" fill="#0f172a" opacity="0.4" stroke="#334155" strokeWidth="1.5"/>
    ...
    <g transform="translate(280, 310)">
      ...
      <rect x="0" y="0" width="70" height="50" rx="2" fill="#2d5016" stroke="#3d6b1f" strokeWidth="1.5"/>
      {/* Circuit traces */}
      <line x1="10" y1="10" x2="60" y2="10" stroke="#4a7c1f" strokeWidth="0.5"/>
      <line x1="10" y1="20" x2="60" y2="20" stroke="#4a7c1f" strokeWidth="0.5"/>
      <line x1="10" y1="30" x2="60" y2="30" stroke="#4a7c1f" strokeWidth="0.5"/>
      <line x1="10" y1="40" x2="60" y2="40" stroke="#4a7c1f" strokeWidth="0.5"/>
      {/* Silver heatsink fins */}
      <rect x="5" y="5" width="60" height="40" fill="#94a3b8" opacity="0.7"/>
      <line x1="10" y1="5" x2="10" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="15" y1="5" x2="15" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="20" y1="5" x2="20" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="25" y1="5" x2="25" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="30" y1="5" x2="30" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="35" y1="5" x2="35" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="40" y1="5" x2="40" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="45" y1="5" x2="45" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="50" y1="5" x2="50" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="55" y1="5" x2="55" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      <line x1="60" y1="5" x2="60" y2="45" stroke="#cbd5e1" strokeWidth="1"/>
      {/* Amber LED strip */}
      <rect x="0" y="50" width="70" height="4" fill="#f59e0b" opacity="0.9" rx="1">
        <animate attributeName="opacity" values="0.7;1;0.7" dur="2s" repeatCount="indefinite"/>
      </rect>
      {/* NVIDIA logo area */}
      <text x="35" y="28" fontFamily="sans-serif" fontSize="8" fill="#10b981" textAnchor="middle" fontWeight="700" opacity="0.8">NVIDIA</text>
    </g>
  ...
  <g id="workstation">
    ...
    <g transform="translate(760, 200)">
      {/* Monitor frame */}
      <rect x="0" y="0" width="180" height="140" rx="6" fill="#1e293b" stroke="#334155" strokeWidth="3"/>
      {/* Screen */}
      <rect x="6" y="6" width="168" height="115" rx="3" fill="#0a0f1a"/>
      {/* Code editor content */}
      <rect x="10" y="10" width="160" height="105" fill="#0f172a"/>
      {/* Syntax highlighting simulation */}
      <line x1="15" y1="20" x2="60" y2="20" stroke="#3b82f6" strokeWidth="2"/>
      <line x1="65" y1="20" x2="90" y2="20" stroke="#10b981" strokeWidth="2"/>
      <line x1="15" y1="30" x2="45" y2="30" stroke="#f59e0b" strokeWidth="2"/>
      <line x1="50" y1="30" x2="110" y2="30" stroke="#14b8a6" strokeWidth="2"/>
      <line x1="25" y1="40" x2="75" y2="40" stroke="#3b82f6" strokeWidth="2"/>
      <line x1="80" y1="40" x2="120" y2="40" stroke="#a855f7" strokeWidth="2"/>
      <line x1="25" y1="50" x2="95" y2="50" stroke="#10b981" strokeWidth="2"/>
      <line x1="15" y1="60" x2="55" y2="60" stroke="#f59e0b" strokeWidth="2"/>
      <line x1="60" y1="60" x2="100" y2="60" stroke="#14b8a6" strokeWidth="2"/>
      <line x1="25" y1="70" x2="85" y2="70" stroke="#3b82f6" strokeWidth="2"/>
      <line x1="15" y1="80" x2="70" y2="80" stroke="#10b981" strokeWidth="2"/>
      <line x1="25" y1="90" x2="105" y2="90" stroke="#a855f7" strokeWidth="2"/>
      <line x1="15" y1="100" x2="50" y2="100" stroke="#f59e0b" strokeWidth="2"/>
      {/* Cursor blink */}
    ...
    <g transform="translate(960, 200)">
      ...
      <text x="15" y="25" fontFamily="monospace" fontSize="7" fill="#10b981">$ rbee inference start</text>
      <text x="15" y="35" fontFamily="monospace" fontSize="7" fill="#10b981">[OK] Worker ready</text>
      <text x="15" y="45" fontFamily="monospace" fontSize="7" fill="#10b981">[OK] Model loaded</text>
      <text x="15" y="55" fontFamily="monospace" fontSize="7" fill="#10b981">[OK] GPU detected</text>
      <text x="15" y="65" fontFamily="monospace" fontSize="7" fill="#14b8a6">Generating tokens...</text>
      <rect x="15" y="70" width="80" height="2" fill="#10b981" opacity="0.8"/>
      <text x="15" y="80" fontFamily="monospace" fontSize="7" fill="#64748b">████████████░░░░ 75%</text>
      <text x="15" y="90" fontFamily="monospace" fontSize="7" fill="#10b981">45.3 tok/s</text>
      {/* Cursor */}
    ...
    <rect x="800" y="450" width="180" height="50" rx="4" fill="#0a0f1a" stroke="#1e293b" strokeWidth="2"/>
    {/* Key caps */}
    <g opacity="0.6">
    ...
    {/* Mouse */}
    <ellipse cx="1000" cy="475" rx="18" ry="28" fill="#0a0f1a" stroke="#1e293b" strokeWidth="2"/>
    <line x1="1000" y1="455" x2="1000" y2="485" stroke="#1e293b" strokeWidth="1"/>
    
    {/* Cable management (clean) */}
    <line x1="838" y1="420" x2="838" y2="520" stroke="#334155" strokeWidth="2" opacity="0.3"/>
    <line x1="1038" y1="420" x2="1038" y2="520" stroke="#334155" strokeWidth="2" opacity="0.3"/>
  ...
  <g id="macStudio">
    ...
    <g transform="translate(1380, 420)">
      {/* Main body */}
      <rect x="0" y="0" width="120" height="48" rx="8" fill="#cbd5e1" stroke="#94a3b8" strokeWidth="2"/>
      ...
      <line x1="10" y1="15" x2="110" y2="15" stroke="#94a3b8" strokeWidth="0.3" opacity="0.5"/>
      <line x1="10" y1="20" x2="110" y2="20" stroke="#94a3b8" strokeWidth="0.3" opacity="0.5"/>
      <line x1="10" y1="30" x2="110" y2="30" stroke="#94a3b8" strokeWidth="0.3" opacity="0.5"/>
    </g>
    
    {/* 24-inch Display */}
    <g transform="translate(1320, 180)">
      {/* Monitor frame (thin bezels) */}
      <rect x="0" y="0" width="240" height="170" rx="8" fill="#e2e8f0" stroke="#cbd5e1" strokeWidth="3"/>
      {/* Screen */}
      ...
      <text x="175" y="45" fontFamily="sans-serif" fontSize="6" fill="#94a3b8">Layers</text>
    ...
    <rect x="1340" y="450" width="200" height="45" rx="4" fill="#e2e8f0" stroke="#cbd5e1" strokeWidth="2"/>
    {/* Keys */}
    <g opacity="0.7">
    ...
    {/* Wireless trackpad */}
    <rect x="1550" y="455" width="70" height="35" rx="4" fill="#e2e8f0" stroke="#cbd5e1" strokeWidth="2"/>
  ...
  <g id="network" filter="url(#glow)">
    ...
    <line x1="460" y1="300" x2="760" y2="280" stroke="#14b8a6" strokeWidth="3" strokeLinecap="round" opacity="0.9">
      <animate attributeName="opacity" values="0.7;1;0.7" dur="2s" repeatCount="indefinite"/>
    </line>
    
    {/* Workstation to Mac Studio (main connection) */}
    <line x1="1140" y1="280" x2="1380" y2="300" stroke="#14b8a6" strokeWidth="3" strokeLinecap="round" opacity="0.9">
      <animate attributeName="opacity" values="0.8;1;0.8" dur="2.2s" repeatCount="indefinite"/>
    </line>
    
    {/* Gaming PC to Mac Studio (mesh topology) */}
    <path d="M 460 320 Q 920 380 1380 320" stroke="#14b8a6" strokeWidth="2.5" fill="none" strokeLinecap="round" opacity="0.6">
      <animate attributeName="opacity" values="0.4;0.7;0.4" dur="3s" repeatCount="indefinite"/>
    </path>
    
    {/* Node indicators at each machine */}
    {/* Gaming PC node */}
    <circle cx="460" cy="310" r="8" fill="#14b8a6" opacity="0.8" stroke="#14b8a6" strokeWidth="2">
      <animate attributeName="r" values="8;10;8" dur="2s" repeatCount="indefinite"/>
    </circle>
    <circle cx="460" cy="310" r="15" fill="none" stroke="#14b8a6" opacity="0.3" strokeWidth="1">
      <animate attributeName="r" values="15;20;15" dur="2s" repeatCount="indefinite"/>
      <animate attributeName="opacity" values="0.3;0;0.3" dur="2s" repeatCount="indefinite"/>
    </circle>
    
    {/* Workstation node */}
    <circle cx="950" cy="280" r="8" fill="#14b8a6" opacity="0.8" stroke="#14b8a6" strokeWidth="2">
      <animate attributeName="r" values="8;10;8" dur="2.2s" repeatCount="indefinite"/>
    </circle>
    <circle cx="950" cy="280" r="15" fill="none" stroke="#14b8a6" opacity="0.3" strokeWidth="1">
    ...
    {/* Mac Studio node */}
    <circle cx="1380" cy="310" r="8" fill="#14b8a6" opacity="0.8" stroke="#14b8a6" strokeWidth="2">
      <animate attributeName="r" values="8;10;8" dur="2.4s" repeatCount="indefinite"/>
    </circle>
    <circle cx="1380" cy="310" r="15" fill="none" stroke="#14b8a6" opacity="0.3" strokeWidth="1">
    ...
    <line x1="460" y1="300" x2="760" y2="280" stroke="#14b8a6" strokeWidth="6" strokeLinecap="round" opacity="0.2" filter="url(#softGlow)"/>
    <line x1="1140" y1="280" x2="1380" y2="300" stroke="#14b8a6" strokeWidth="6" strokeLinecap="round" opacity="0.2" filter="url(#softGlow)"/>
    <path d="M 460 320 Q 920 380 1380 320" stroke="#14b8a6" strokeWidth="5" fill="none" strokeLinecap="round" opacity="0.15" filter="url(#softGlow)"/>
  </g>
  ...
  <g id="uiOverlays">
    ...
    <g transform="translate(710, 60)">
      ...
      <rect x="0" y="0" width="500" height="85" rx="10" fill="#0f172a" opacity="0.85" stroke="#14b8a6" strokeWidth="2"/>
      
      {/* Title */}
      <text x="250" y="30" fontFamily="sans-serif" fontSize="22" fill="#f1f5f9" textAnchor="middle" fontWeight="700">
        Private AI Cluster
      </text>
      ...
      <g transform="translate(0, 45)">
        ...
        <g transform="translate(80, 0)">
          ...
          <text x="25" y="18" fontFamily="sans-serif" fontSize="14" fill="#14b8a6" fontWeight="600">8 GPUs</text>
        </g>
        ...
        <g transform="translate(210, 0)">
          ...
          <line x1="10" y1="10" x2="18" y2="14" stroke="#14b8a6" strokeWidth="1"/>
          <line x1="10" y1="18" x2="18" y2="14" stroke="#14b8a6" strokeWidth="1"/>
          <text x="25" y="18" fontFamily="sans-serif" fontSize="14" fill="#14b8a6" fontWeight="600">3 nodes</text>
        </g>
        
        {/* Cost savings */}
        <g transform="translate(340, 0)">
          <rect x="0" y="0" width="120" height="28" rx="6" fill="#10b981" opacity="0.2"/>
          <text x="10" y="10" fontFamily="sans-serif" fontSize="20" fill="#10b981" fontWeight="700">$</text>
          <line x1="15" y1="5" x2="25" y2="15" stroke="#10b981" strokeWidth="2"/>
          <text x="35" y="18" fontFamily="sans-serif" fontSize="14" fill="#10b981" fontWeight="700">0/mo API</text>
        </g>
      </g>
    </g>
    ...
    <g transform="translate(300, 240)">
      <rect x="0" y="0" width="100" height="24" rx="4" fill="#0f172a" opacity="0.7" stroke="#f59e0b" strokeWidth="1"/>
      <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#f59e0b" textAnchor="middle" fontWeight="600">Gaming PC</text>
    </g>
    
    {/* Workstation label */}
    <g transform="translate(850, 160)">
      <rect x="0" y="0" width="100" height="24" rx="4" fill="#0f172a" opacity="0.7" stroke="#3b82f6" strokeWidth="1"/>
      <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#3b82f6" textAnchor="middle" fontWeight="600">Workstation</text>
    </g>
    
    {/* Mac Studio label */}
    <g transform="translate(1380, 360)">
      <rect x="0" y="0" width="100" height="24" rx="4" fill="#0f172a" opacity="0.7" stroke="#cbd5e1" strokeWidth="1"/>
      <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#f8fafc" textAnchor="middle" fontWeight="600">Mac Studio</text>
    </g>
  </g>
