    ...
    >
      ...
      <g id="workstation">
        ...
        <g transform="translate(960, 200)">
          ...
          <text x="15" y="25" fontFamily="monospace" fontSize="7" fill="#10b981">
            $ rbee inference start
          </text>
          <text x="15" y="35" fontFamily="monospace" fontSize="7" fill="#10b981">
            [OK] Worker ready
          </text>
          <text x="15" y="45" fontFamily="monospace" fontSize="7" fill="#10b981">
            [OK] Model loaded
          </text>
          <text x="15" y="55" fontFamily="monospace" fontSize="7" fill="#10b981">
            [OK] GPU detected
          </text>
          <text x="15" y="65" fontFamily="monospace" fontSize="7" fill="#14b8a6">
            Generating tokens...
          </text>
          <rect x="15" y="70" width="80" height="2" fill="#10b981" opacity="0.8" />
          <text x="15" y="80" fontFamily="monospace" fontSize="7" fill="#64748b">
            ████████████░░░░ 75%
          </text>
          <text x="15" y="90" fontFamily="monospace" fontSize="7" fill="#10b981">
            45.3 tok/s
          </text>
          {/* Cursor */}
      ...
      <g id="macStudio">
        ...
        <g transform="translate(1320, 180)">
          ...
          <text x="175" y="45" fontFamily="sans-serif" fontSize="6" fill="#94a3b8">
            Layers
          </text>
      ...
      <g id="network" filter="url(#glow)">
        ...
        <path
          d="M 460 320 Q 920 380 1380 320"
          stroke="#14b8a6"
          strokeWidth="2.5"
          fill="none"
          strokeLinecap="round"
      ...
      <g id="uiOverlays">
        ...
        <g transform="translate(710, 60)">
          ...
          <g transform="translate(0, 45)">
            ...
            <g transform="translate(80, 0)">
              ...
              <text x="25" y="18" fontFamily="sans-serif" fontSize="14" fill="#14b8a6" fontWeight="600">
                8 GPUs
              </text>
            </g>
            ...
            <g transform="translate(340, 0)">
              ...
              <text x="10" y="10" fontFamily="sans-serif" fontSize="20" fill="#10b981" fontWeight="700">
                $
              </text>
              <line x1="15" y1="5" x2="25" y2="15" stroke="#10b981" strokeWidth="2" />
              <text x="35" y="18" fontFamily="sans-serif" fontSize="14" fill="#10b981" fontWeight="700">
                0/mo API
              </text>
            </g>
          </g>
        ...
        <g transform="translate(300, 240)">
          <rect
            ...
            strokeWidth="1"
          />
          <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#f59e0b" textAnchor="middle" fontWeight="600">
            Gaming PC
          </text>
        </g>
        ...
        <g transform="translate(850, 160)">
          <rect
            ...
            strokeWidth="1"
          />
          <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#3b82f6" textAnchor="middle" fontWeight="600">
            Workstation
          </text>
        </g>
        ...
        <g transform="translate(1380, 360)">
          <rect
            ...
            strokeWidth="1"
          />
          <text x="50" y="16" fontFamily="sans-serif" fontSize="10" fill="#f8fafc" textAnchor="middle" fontWeight="600">
            Mac Studio
          </text>
        </g>
      </g>
