...
export function DevGrid({ size = 96, className, ...props }: DevGridProps) {
  ...
  {/* Code window */}
  <rect x="20" y="28" width="56" height="40" rx="4" className="fill-slate-100 dark:fill-slate-800 stroke-blue-500" strokeWidth="1.5"/>
  
  {/* Code lines */}
  <line x1="26" y1="36" x2="46" y2="36" className="stroke-blue-500" strokeWidth="2" strokeLinecap="round"/>
  <line x1="26" y1="44" x2="56" y2="44" className="stroke-blue-500" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
  <line x1="26" y1="52" x2="40" y2="52" className="stroke-blue-500" strokeWidth="2" strokeLinecap="round" opacity="0.4"/>
