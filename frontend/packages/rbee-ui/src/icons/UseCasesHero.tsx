...
export function UseCasesHero({ size = 1080, className, ...props }: UseCasesHeroProps) {
  return (
    ...
    >
      ...
      {/* Terminal text lines */}
      <text x="220" y="285" fontFamily="monospace" fontSize="12" fill="#10b981" opacity="0.8">
        $ llama-cli --model llama-70b
      </text>
      <text x="220" y="305" fontFamily="monospace" fontSize="12" fill="#10b981" opacity="0.7">
        Loading model...
      </text>
      <text x="220" y="325" fontFamily="monospace" fontSize="12" fill="#10b981" opacity="0.6">
        Generating tokens...
      </text>
      <text x="220" y="345" fontFamily="monospace" fontSize="12" fill="#10b981" opacity="0.5">
        ▊
      </text>
      ...
      <text x="435" y="220" fontFamily="cursive" fontSize="16" fill="#0f172a" fontWeight="500">
        your models,
      </text>
      <text x="435" y="245" fontFamily="cursive" fontSize="16" fill="#0f172a" fontWeight="500">
        your rules
      </text>
