  ...
  return (
    ...
    >
      ...
      <g transform="translate(200, 40)">
        <rect x="0" y="0" width="60" height="60" rx="4" className="fill-slate-200 dark:fill-slate-800 stroke-blue-500" strokeWidth="2"/>
      ...
      <g transform="translate(420, 25)">
        <rect x="0" y="0" width="120" height="90" rx="6" className="fill-slate-200 dark:fill-slate-800 stroke-emerald-500" strokeWidth="2.5"/>
        {/* Rack slots */}
        <rect x="10" y="12" width="100" height="18" rx="2" className="fill-emerald-500 stroke-emerald-500" fillOpacity="0.15" strokeWidth="1.5"/>
        <rect x="10" y="36" width="100" height="18" rx="2" className="fill-emerald-500 stroke-emerald-500" fillOpacity="0.25" strokeWidth="1.5"/>
        <rect x="10" y="60" width="100" height="18" rx="2" className="fill-emerald-500 stroke-emerald-500" fillOpacity="0.2" strokeWidth="1.5"/>
        {/* LED indicators */}
        ...
        {/* GPU label hint */}
        <text x="35" y="25" className="fill-emerald-500" fontSize="8" opacity="0.6">GPU</text>
      </g>
      ...
      <line x1="260" y1="70" x2="420" y2="70" className="stroke-blue-500" strokeWidth="2" opacity="0.4" strokeDasharray="4 4"/>
      <line x1="540" y1="70" x2="700" y2="70" className="stroke-blue-500" strokeWidth="2" opacity="0.4" strokeDasharray="4 4"/>
