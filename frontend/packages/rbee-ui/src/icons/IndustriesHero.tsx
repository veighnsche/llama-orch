  ...
  return (
    ...
    >
      ...
      <g id="financial">
        ...
        <text x="325" y="275" fontFamily="monospace" fontSize="10" fill="#14b8a6" textAnchor="middle">
          ****
        </text>
        {/* Keypad grid */}
        ...
        <g opacity="0.95">
          ...
          <text x="85" y="192" fontFamily="sans-serif" fontSize="11" fill="#14b8a6" textAnchor="middle" opacity="0.9">
            COMPLIANT
          </text>
        </g>
      ...
      <g id="healthcare">
        ...
        <text x="505" y="120" fontFamily="sans-serif" fontSize="13" fontWeight="700" fill="#ffffff" textAnchor="middle">
          HIPAA COMPLIANT
        </text>

        {/* PHI ENCRYPTED label */}
        <rect x="440" y="260" width="130" height="30" fill="#14b8a6" rx="3" />
        <text x="505" y="280" fontFamily="sans-serif" fontSize="12" fontWeight="700" fill="#ffffff" textAnchor="middle">
          PHI ENCRYPTED
        </text>
      ...
      <g id="government">
        ...
        <g transform="translate(1104, 200)">
          ...
          <text x="0" y="55" fontFamily="serif" fontSize="9" fontWeight="700" fill="#1e293b" textAnchor="middle">
            E PLURIBUS UNUM
          </text>
        ...
        <g transform="translate(1000, 120)" opacity="0.95">
          ...
          <text x="45" y="35" fontFamily="sans-serif" fontSize="16" fontWeight="900" fill="#dc2626" textAnchor="middle">
            TOP
          </text>
          <text x="45" y="55" fontFamily="sans-serif" fontSize="16" fontWeight="900" fill="#dc2626" textAnchor="middle">
            SECRET
          </text>
          <rect x="15" y="65" width="60" height="2" fill="#dc2626" />
          <text x="45" y="85" fontFamily="sans-serif" fontSize="10" fontWeight="700" fill="#14b8a6" textAnchor="middle">
            ITAR
          </text>
          <text
            x="45"
        ...
        <g transform="translate(1158, 430)" opacity="0.9">
          ...
          <text x="40" y="25" fontFamily="sans-serif" fontSize="11" fontWeight="700" fill="#3b82f6" textAnchor="middle">
            SECURITY
          </text>
          <text x="40" y="42" fontFamily="sans-serif" fontSize="11" fontWeight="700" fill="#3b82f6" textAnchor="middle">
            CLEARANCE
          </text>
          <text x="40" y="55" fontFamily="monospace" fontSize="9" fill="#64748b" textAnchor="middle">
            L5-DELTA
          </text>
        </g>
      ...
      <g id="education">
        ...
        <g transform="translate(1288, 180)">
          ...
          <text x="40" y="50" fontFamily="monospace" fontSize="7" fill="#64748b" textAnchor="middle">
            ENCRYPTED
          </text>
          {/* FERPA watermark */}
          <text x="40" y="28" fontFamily="sans-serif" fontSize="6" fill="#14b8a6" textAnchor="middle" opacity="0.5">
            FERPA
          </text>
          {/* Stand */}
        ...
        <g transform="translate(1320, 100)">
          ...
          <text x="70" y="25" fontFamily="sans-serif" fontSize="16" fontWeight="700" fill="#ffffff" textAnchor="middle">
            FERPA
          </text>
          <text x="70" y="42" fontFamily="sans-serif" fontSize="11" fill="#ffffff" textAnchor="middle">
            PROTECTED
          </text>
        </g>
