...
export function FeaturesHero() {
  ...
  const subcopyContent = (
    <>
      <BrandWordmark size="lg" /> (pronounced &ldquo;are-bee&rdquo;) gives you enterprise AI orchestration that runs
      on your own hardware. OpenAI-compatible. No cloud lock-in. No ongoing API costs. Full control.
    </>
  )
  ...
  return (
    <>
      <HeroTemplate
        ...
        background={SHOW_HONEYCOMB_BG ? { variant: 'honeycomb', size: 'small', fadeDirection: 'bottom' } : { variant: 'gradient' }}
        padding="default"
      />
