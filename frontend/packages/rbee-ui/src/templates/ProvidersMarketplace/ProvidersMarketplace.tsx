        ...
        {featureTiles.map((tile, idx) => {
          ...
          return (
            <div
              ...
              } rounded-2xl border/60 bg-card/60 p-6 text-center backdrop-blur motion-reduce:animate-none supports-[backdrop-filter]:bg-background/60`}
            >
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border bg-background/60 p-6 transition-transform hover:translate-y-0.5">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <div className="tabular-nums text-2xl font-extrabold text-primary">
                    {standardCommissionValue}
                  </div>
                </div>
                <div className="text-sm text-muted-foreground">
              ...
              <div className="rounded-xl border border-emerald-400/30 bg-emerald-400/10 p-6 transition-transform hover:translate-y-0.5">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <div className="tabular-nums text-2xl font-extrabold text-emerald-400">
                    {youKeepValue}
                  </div>
                </div>
