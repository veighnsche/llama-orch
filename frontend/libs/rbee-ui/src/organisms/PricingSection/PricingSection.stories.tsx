...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'Default pricing section for homepage. Use the theme toggle in the toolbar to switch between light and dark modes.',
      },
    },
  },
};
...
export const MobileView: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: 'Mobile view with stacked pricing cards. Team tier appears first on mobile.',
      },
    },
  },
};
  ...
  render: () => (
    <div>
      ...
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>Pricing Highlights</h2>
        <div style={{ maxWidth: '800px', margin: '0 auto', display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
          <div>
            <h3 style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Home/Lab (Free)</h3>
            <p style={{ fontSize: '0.875rem', color: '#666' }}>Unlimited GPUs on your hardware. No feature gates. Perfect for individuals and homelabs.</p>
          </div>
          <div>
            <h3 style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Team (€99/mo)</h3>
            <p style={{ fontSize: '0.875rem', color: '#666' }}>Web UI, shared workspaces, priority support. Most popular for growing teams.</p>
          </div>
          <div>
            <h3 style={{ fontWeight: 'bold', marginBottom: '0.5rem' }}>Enterprise (Custom)</h3>
            <p style={{ fontSize: '0.875rem', color: '#666' }}>Dedicated instances, custom SLAs, white-label options. For organizations.</p>
          </div>
        </div>
      </div>
    </div>
