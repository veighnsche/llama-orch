...
export function TopologyDiagram({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(48rem_28rem_at_50%_10%,oklch(0.98_0_0/.06),transparent_60%)]" aria-hidden="true" />
      ...
      <div className={cn('relative w-full', compact ? 'h-[400px]' : 'h-[500px]')}>
        ...
        >
          ...
          <g fill="none" strokeLinecap="round">
            {edges.map((e) => {
              ...
              const edgeCls =
                e.kind === 'telemetry'
                  ? 'stroke-chart-3/50 [stroke-dasharray:4_4]'
                  : 'stroke-border'
        ...
        <p id="topology-desc" className="sr-only">
          Queen-rbee schedules jobs to Hive Managers, which dispatch tasks to Workers. Workers report telemetry upstream.
        </p>
