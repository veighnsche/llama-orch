...
export const Default: Story = {
  parameters: {
    docs: {
      description: {
        story: 'Default email capture form ready for input. Use the theme toggle in the toolbar to switch between light and dark modes.',
      },
    },
  },
};
  ...
  render: () => (
    <div>
      ...
      <div style={{ padding: '2rem', background: 'rgba(0,0,0,0.02)' }}>
        <h2 style={{ fontSize: '1.5rem', fontWeight: 'bold', marginBottom: '1rem', textAlign: 'center' }}>Form States</h2>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Default State</h3>
          <p style={{ marginBottom: '1rem', color: '#666' }}>Form is ready for input with email icon and placeholder text.</p>
          
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Success State</h3>
          <p style={{ marginBottom: '1rem', color: '#666' }}>After submission, shows green checkmark with confirmation message. Auto-resets after 3 seconds.</p>
          
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Validation</h3>
          <p style={{ marginBottom: '1rem', color: '#666' }}>HTML5 email validation prevents submission of invalid emails. Try submitting without "@" symbol.</p>
          
          <h3 style={{ fontWeight: 'bold', marginTop: '1rem', marginBottom: '0.5rem' }}>Trust Elements</h3>
          <p style={{ color: '#666' }}>Lock icon and "No spam" message build trust. GitHub link provides transparency.</p>
        </div>
      </div>
    </div>
  ),
...
export const WithPageContext: Story = {
  render: () => (
    <div>
      <div style={{ padding: '4rem 2rem', textAlign: 'center', background: 'linear-gradient(to bottom, transparent, rgba(0,0,0,0.02))' }}>
