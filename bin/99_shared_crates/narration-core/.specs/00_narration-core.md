...
**NARR-6003**: Tests MUST emit  per monorepo standard (PB-1001..PB-1011).
**NARR-6004**: Tests MUST respect `LLORCH_RUN_ID` and `LLORCH_PROOF_DIR` environment variables.
**NARR-6005**:  MUST include autogenerated headers per PB-1012.
...
- [ ] All integration tests emit  (pending)
...
---
## References
- **Proof Bundle Standard**: `libs//.specs/00_.md` (PB-1001..PB-1011)
