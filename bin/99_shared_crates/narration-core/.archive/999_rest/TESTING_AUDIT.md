# Testing Audit Report — Narration Core
...
9. **Service migrations** — Migrate queen-rbee, pool-managerd, worker-orcd
...
2. **Integration Tests**:
   - Multi-service correlation ID propagation (queen-rbee → pool-managerd → worker-orcd)
