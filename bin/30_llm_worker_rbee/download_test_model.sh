#!/bin/bash
# Download TinyLlama 1.1B SafeTensors for llm-worker-rbee testing
# Created by: TEAM-010
#
# llm-worker-rbee requires SafeTensors format (not GGUF)
...
echo "Purpose: Test llm-worker-rbee inference"
