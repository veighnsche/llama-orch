...
#define TOP_HAT_Q_GEMM_COMPUTE_32F 0
    ...
    //
    // ============================================================================
    // [TEAM DICKINSON] 2025-10-08T00:41Z - ⚠️ WE'RE DOING TRANSPOSE HERE! ⚠️
    // ============================================================================
    // CUBLAS_OP_T = TRANSPOSE the weight matrix!
    //
    // WHY: GGUF stores weights in ROW-MAJOR, cuBLAS expects COLUMN-MAJOR
    //      GGUF [hidden_dim, q_dim] row-major = cuBLAS [q_dim, hidden_dim] column-major
    //      So we use CUBLAS_OP_T to transpose it back to correct orientation
    //
    // THIS IS CORRECT! Do NOT add another transpose!
    //
    // See: investigation-teams/TRANSPOSE_FALSE_LEAD.md
    //      ROOT_CAUSE_ANALYSIS.md (explains row-major vs column-major)
    //      src/cuda/weight_loader.rs:560 (confirms GGUF is row-major)
    // ============================================================================
    cublasGemmEx(cublas_handle_, CUBLAS_OP_T, CUBLAS_OP_N, 
                 q_dim, batch_size, config_.hidden_dim, 
                 &alpha, 
    ...
    // [TEAM DICKINSON] 2025-10-08T00:41Z - ⚠️ TRANSPOSE via CUBLAS_OP_T (correct!)
    // [TEAM REMBRANDT 2025-10-08] Restored/Confirmed: CUBLAS_OP_T with lda=q_dim per PICASSO verdict
