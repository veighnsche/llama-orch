...
mod vram_boundary_tests {
    ...
    fn test_gpt_oss_20b_fits_24gb() {
        ...
        let mxfp4_size = |elements: usize| -> usize { ((elements + 31) / 32) * 17 };
        ...
        println!("\n  VRAM Breakdown:");
        println!(
            "    Model weights (MXFP4): {:.2} GB",
            total_weights as f64 / 1024.0 / 1024.0 / 1024.0
        );
    ...
    fn test_vram_residency_verification() {
        ...
        let device_ptr = PointerAttributes { memory_type: MemoryType::Device, host_pointer: None };
        ...
        let managed_ptr =
            PointerAttributes { memory_type: MemoryType::Managed, host_pointer: Some(0x12345678) };
    ...
    fn test_vram_fragmentation() {
        ...
        if !can_allocate {
            ...
            println!(
                "    Free: {:.2} GB, but largest block: {:.2} GB",
