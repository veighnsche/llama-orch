...
//! Copied from: bin/10_queen_rbee/src/http/dev_proxy.rs
//!
...
//! - Development: http://localhost:7835/dev → Proxy to http://localhost:7836
//!
...
///
/// TEAM-374: Forwards requests to Vite dev server at localhost:7836
...
pub async fn dev_proxy_handler(uri: Uri, req: Request) -> impl IntoResponse {
    ...
    let vite_url = format!("http://localhost:7836{}{}", path, query);
