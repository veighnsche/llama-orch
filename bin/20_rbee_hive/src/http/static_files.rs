...
//! ============================================================================
//! The UI is served at http://localhost:7835/ NOT http://localhost:7835/ui
//! 
//! This is a HARD REQUIREMENT. DO NOT CHANGE THIS.
//! DO NOT nest under /ui. DO NOT add prefixes.
//! 
//! TEAM-378: Always serves embedded static files from ui/app/dist/ at ROOT (/)
//! No dev proxy - UI changes require hive rebuild (cargo build -p rbee-hive)
//!
//! API routes (/health, /v1/*, /capabilities) take priority via router merge order.
...
/// Embedded static assets from rbee-hive UI production build
///
/// TEAM-378: Files are embedded at compile time from ui/app/dist/
...
///
/// TEAM-378: Always serve embedded static files from dist/
/// No dev proxy - UI changes require hive rebuild
...
///
/// TEAM-378: Used in both debug and release modes
/// UI changes require hive rebuild
