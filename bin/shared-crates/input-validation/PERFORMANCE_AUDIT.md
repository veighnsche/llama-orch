...
- **Hot path**: Request handlers in orchestratord, pool-managerd, worker-orcd
...
**Typical request validation chain** (orchestratord):
...
4. **Integration tests**: Verify behavior in real request handlers (orchestratord, pool-managerd)
