...
**Used by**: orchestratord, pool-managerd, vram-residency, worker-orcd
...
sudo chown orchestratord:orchestratord /etc/llorch/secrets/api-token
...
# Output should show:
# -rw------- 1 orchestratord orchestratord 65 Oct  1 21:00 api-token
...
| `CREDENTIALS_DIRECTORY` | Systemd credentials directory | `/run/credentials/orchestratord.service` |
...
### 1. orchestratord: API Token Authentication
...
- ⬜ Integration with orchestratord/pool-managerd
