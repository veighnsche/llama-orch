...
**Missing**: How do correlation IDs flow orchestratord → worker-orcd → pool-managerd?
...
4. ✅ **Updated README** (`README.md`)
   ...
   - Placeholder for future guides (orchestratord, pool-managerd)
...
1. **Narration-Core**: Create integration guides for orchestratord and pool-managerd
...
- ⏳ Distributed tracing works end-to-end (orchestratord → worker-orcd → pool-managerd)
