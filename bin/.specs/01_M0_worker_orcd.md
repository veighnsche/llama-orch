...
- `retriable` — Boolean (true if queen-rbee can retry)
...
**Output**:  with timing histograms (p50, p95, p99).
...
All M0 tests MUST emit  per `libs/` standard:
...
**Spec Reference**: Memory about  standard
---
...
**Next Steps**: 
1. Remove  references from all specs and code
