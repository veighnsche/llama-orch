# rbee-hive-model-provisioner-bdd

**Status:** 🚧 STUB (Created by TEAM-135)  
**Purpose:** BDD test harness for rbee-hive-model-provisioner

## Overview

Behavior-Driven Development test harness for rbee-hive-model-provisioner.
