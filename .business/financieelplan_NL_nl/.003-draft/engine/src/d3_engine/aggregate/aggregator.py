...
def write_consolidated_outputs(out_dir: Path, context: Dict[str, Any]) -> List[str]:
    ...
    pub_rev_m = sum_by_month(pub_scen, "month", "revenue_eur", scenario="base")
    pub_cost_m = sum_by_month(pub_scen, "month", "cost_eur", scenario="base")
    prv_rev_m = sum_by_month(prv_cust, "month", "revenue_eur")
    prv_cost_m = sum_by_month(prv_costs, "month", "cost_eur")
