...
pub async fn metrics_endpoint() -> axum::response::Response {
    ...
    metrics::inc_counter(
        ...
        &[("engine", "llamacpp"), ("engine_version", "v0"), ("pool_id", "default"), ("replica_id", "r0"), ("reason", "client")],
    );
    metrics::inc_counter(
    ...
    metrics::set_gauge(
        "gpu_utilization",
        &[("engine", "llamacpp"), ("engine_version", "v0"), ("pool_id", "default"), ("replica_id", "r0"), ("device", "gpu0")],
        0,
    );
    metrics::set_gauge(
        "vram_used_bytes",
