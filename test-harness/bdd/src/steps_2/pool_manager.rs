...
pub async fn given_pool_unready_due_to_preload_failure(world: &mut World) { world.push_fact("pool.preload_fail"); }
...
pub async fn given_driver_error_occurs(world: &mut World) { world.push_fact("pool.driver_error"); }
...
pub async fn given_device_masks_configured(world: &mut World) { world.push_fact("pool.device_masks"); }
...
pub async fn given_heterogeneous_split_ratios_configured(world: &mut World) { world.push_fact("pool.hetero_split"); }
