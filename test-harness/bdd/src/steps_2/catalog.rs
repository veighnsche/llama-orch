...
pub async fn given_catalog_model_payload(world: &mut World) { world.push_fact("catalog.payload"); }

#[when(regex = r"^I create a catalog model$")]
pub async fn when_create_catalog_model(world: &mut World) { world.push_fact("catalog.create"); }
...
pub async fn when_get_catalog_model(world: &mut World) { world.push_fact("catalog.get"); }
...
pub async fn when_verify_catalog_model(world: &mut World) { world.push_fact("catalog.verify"); }
