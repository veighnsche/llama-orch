...
pub async fn given_valid_example_config(world: &mut World) { world.push_fact("config.example"); }
...
pub async fn given_strict_mode_with_unknown_field(world: &mut World) { world.push_fact("config.strict_unknown"); }
...
pub async fn given_schema_generated_twice(world: &mut World) { world.push_fact("config.schema_twice"); }
