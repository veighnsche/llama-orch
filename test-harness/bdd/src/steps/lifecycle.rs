...
pub async fn when_set_state_deprecated_with_deadline(world: &mut World) { world.push_fact("lifecycle.deprecate"); }
...
pub async fn when_set_state_retired(world: &mut World) { world.push_fact("lifecycle.retire"); }
