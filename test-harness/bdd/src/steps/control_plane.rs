...
pub async fn when_request_pool_drain(world: &mut World) {
    ...
    let _ = world.http_call(Method::POST, "/v1/pools/pool0/drain", Some(body)).await;
}
...
pub async fn when_request_pool_reload(world: &mut World) {
    ...
    let _ = world.http_call(Method::POST, "/v1/pools/pool0/reload", Some(body)).await;
}
...
pub async fn when_request_capabilities(world: &mut World) {
    ...
    let _ = world.http_call(http::Method::GET, "/v1/capabilities", None).await;
}
