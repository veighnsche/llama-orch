...
pub async fn when_request_pool_health(world: &mut World) { world.push_fact("cp.health"); }
...
pub async fn when_request_pool_drain(world: &mut World) { world.push_fact("cp.drain"); }
...
pub async fn when_request_pool_reload(world: &mut World) { world.push_fact("cp.reload"); }
...
pub async fn when_request_replicasets(world: &mut World) { world.push_fact("cp.replicasets"); }
