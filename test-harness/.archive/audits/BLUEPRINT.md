...
|------|--------|---------------------|
| Orchestrator Team | `bin/queen-rbee`, `bin/queen-rbee-crates/*` | Unit, BDD, integration tests for orchestrator logic |
...
- **New**: `bin/queen-rbee/tests/determinism/`
- **Rationale**: Determinism is an orchestrator property
#### Chaos Tests
- **Old**: `test-harness/chaos/`
- **New**: `bin/queen-rbee/tests/chaos/` or `bin/pool-managerd/tests/chaos/`
- **Rationale**: Chaos tests target specific components
#### E2E Haiku Tests
- **Old**: `test-harness/e2e-haiku/`
- **New**: `bin/queen-rbee/tests/e2e/` or dedicated `e2e-tests/` crate
...
cargo run -p queen-rbee-bdd --bin bdd-runner
# Run specific test
cargo test -p queen-rbee -- test_enqueue
# Run with 
...
- [ ] Determinism tests moved to `bin/queen-rbee/tests/determinism/`
- [ ] Chaos tests moved to appropriate component crates
- [ ] E2E tests moved to `bin/queen-rbee/tests/e2e/` or dedicated crate
...
---
## Open Questions
1. **E2E Test Location**: Should E2E tests live in `bin/queen-rbee/tests/e2e/` or a dedicated top-level `e2e-tests/` crate?
   - **Recommendation**: Start in `bin/queen-rbee/tests/e2e/`, extract if it grows large
